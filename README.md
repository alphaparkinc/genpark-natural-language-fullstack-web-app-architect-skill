# genpark-natural-language-fullstack-web-app-architect-skill
...
> **GenPark AI Agent Skill** -- Natural language full-stack web application architect & scaffolder (Lovable style)
